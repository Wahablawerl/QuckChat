...
function SideBar() {
  ...
  // normalize online user ids into a Set of strings for reliable lookups
  ...
  // fetch users once we have an authenticated user, and refresh when online status changes
  useEffect(() => {
    if (!authUser) return;
    getUsers();
